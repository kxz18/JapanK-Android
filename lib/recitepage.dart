...
class _RecitePageState extends State<RecitePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(),
        body: Builder(
            builder: (context) => //covered by Builder to provide snackbar
                Column(
                                  ...
                                  onPressed: () {
                                    if (this.curIndex < ids.length - 1)
                                      ...
                                      Scaffold.of(context)
                                        ...
                                        content: Text("Reached the last one!"),
                                      ));
                                  },
                                ))
                          ]),
                ...
                child: Builder(
                  builder: (context) {
                    if (snapshot.hasData) {
                      ...
                      return Text(
                          "An error occurred : ${snapshot.error}, please ignore this word, word id: $wordId");
                    } else
